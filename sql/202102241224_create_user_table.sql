...
CREATE TABLE `user` (
                        ...
                        `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '사용자 이름',
                        `birth_date` datetime NOT NULL COMMENT '생년월일',
                        `gender` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '성별(M:남자, W:여자, U:선택안함)',
                        `tel` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '전화번호',
                        `email` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '사용자 이메일',
...
update version set version = '202102241224';
